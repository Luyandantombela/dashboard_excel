...
window.OverlayElements = (function () {
  ...
  const ICONS = [
    ...
    'receipt', 'file-invoice', 'file-plus', 'file-minus', 'file-x', 'file-check', 'folder-plus',
    ...
    'percent', 'divide', 'equals', 'not-equals', 'greater-than', 'less-than', 'greater-than-equal',
    'less-than-equal', 'infinity', 'pi', 'calculator', 'scissors', 'clipboard-check', 'clipboard-list',
    'clipboard-x', 'clipboard-pen', 'pencil', 'pen', 'pen-tool', 'pen-line', 'pen-square', 'highlighter',
    ...
    'stop', 'skip-forward', 'skip-back', 'rewind', 'fast-forward', 'volume-2', 'volume-x', 'volume-1',
    'maximize', 'minimize', 'fullscreen', 'fullscreen-exit', 'expand', 'shrink', 'corner-down-left',
    ...
    'repeat', 'repeat-1', 'shuffle', 'sync', 'arrow-up-circle', 'arrow-down-circle', 'arrow-left-circle',
    ...
    'sparkles', 'flame', 'fire', 'droplet', 'snowflake', 'umbrella', 'eye', 'eye-off', 'watch',
    ...
    'calendar-plus', 'calendar-range', 'calendar-clock', 'calendar-days', 'calendar-week', 'calendar-month',
    'calendar-year', 'user-plus', 'user-minus', 'user-x', 'user-check', 'user-pen', 'user-square',
    'user-square-check', 'user-square-x', 'user-square-minus', 'user-square-plus', 'user-circle',
    'user-circle-check', 'user-circle-x', 'user-circle-minus', 'user-circle-plus', 'user-search',
    'user-cog', 'user-star', 'user-heart', 'user-lock', 'user-unlock', 'user-key', 'user-shield',
    'crown', 'building', 'building-2', 'apartment', 'hotel', 'hospital', 'school', 'bank',
    'university', 'factory', 'construction', 'scaffold', 'hard-hat', 'tool', 'wrench', 'screwdriver',
    'hammer', 'drill', 'saw', 'axe', 'chainsaw', 'pipe', 'pipe-wrench', 'pliers', 'wire',
    'wifi-off', 'bluetooth-off', 'battery-charging', 'battery-full', 'battery-half', 'battery-low',
    'battery-empty', 'plug', 'plug-zap', 'plug-x', 'plug-off', 'power', 'power-off', 'lightbulb',
    'lightbulb-off', 'lightbulb-zap', 'lamp', 'lamp-desk', 'lamp-floor', 'lamp-wall', 'lamp-ceiling',
    'monitor-off', 'printer-off', 'mouse-pointer-click', 'gamepad-2', 'joystick', 'lock-open',
    'shield-off', 'shield-alert', 'shield-zap', 'shield-heart', 'shield-star', 'shield-dollar',
    'shield-euro', 'shield-pound'
  ];
