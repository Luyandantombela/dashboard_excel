...
window.OverlayElements = (function () {
  ...
  const ICONS = [
    ...
    'shield-check', 'alert-triangle', 'info', 'help-circle', 'alert-circle', 'check-circle-2', 'x-circle',
    ...
    'sliders-horizontal', 'sliders', 'gauge', 'percent', 'divide', 'equals', 'not-equals', 'greater-than', 'less-than',
    'greater-than-equal', 'less-than-equal', 'infinity', 'pi', 'function-square', 'calculator', 'scissors',
    'clipboard-check', 'clipboard-list', 'clipboard-x', 'clipboard-pen', 'clipboard-pen-line', 'edit-3', 'edit-2',
    ...
    'move', 'move-up', 'move-down', 'move-left', 'move-right', 'rotate-cw', 'rotate-ccw',
    ...
    'file-down', 'file-up', 'file-sync', 'cloud-sync', 'cloud-off', 'sunrise', 'sunset',
    'moon-star', 'sparkles', 'flame', 'fire', 'droplet', 'snowflake', 'umbrella',
    'eye', 'eye-off', 'watch', 'clock-1', 'clock-2', 'clock-3',
    'clock-4', 'clock-5', 'clock-6', 'clock-7', 'clock-8', 'clock-9', 'clock-10', 'clock-11',
    'clock-12', 'calendar-check-2', 'calendar-x-2', 'calendar-minus-2', 'calendar-plus-2', 'calendar-range',
    'calendar-clock', 'calendar-days', 'calendar-week', 'calendar-month', 'calendar-year',
    'user-plus', 'user-minus', 'user-x', 'user-check', 'user-pen', 'user-square', 'user-square-check', 'user-square-x',
    'user-square-minus', 'user-square-plus', 'user-circle', 'user-circle-check', 'user-circle-x', 'user-circle-minus',
    'user-circle-plus', 'user-search', 'user-cog', 'user-star', 'user-heart', 'user-lock', 'user-unlock',
    'user-key', 'user-shield', 'user-shield-check', 'user-shield-x', 'user-shield-minus', 'user-shield-plus',
    'user-shield-cog', 'crown', 'building', 'building-2', 'apartment', 'hotel', 'hospital', 'school',
    ...
    'wifi-off', 'bluetooth-off', 'bluetooth-connected', 'bluetooth-searching', 'bluetooth-paired', 'bluetooth-disconnected',
    'battery-charging', 'battery-full', 'battery-half', 'battery-low', 'battery-empty', 'battery-off',
    'plug', 'plug-zap', 'plug-x', 'plug-off', 'power', 'power-off', 'lightbulb', 'lightbulb-off',
    'lightbulb-zap', 'lamp', 'lamp-desk', 'lamp-floor', 'lamp-wall', 'lamp-ceiling', 'lamp-table',
    'tv', 'monitor', 'monitor-off', 'monitor-speaker', 'laptop', 'smartphone', 'printer', 'printer-off',
    'mouse-pointer', 'mouse-pointer-click', 'mouse', 'touchpad', 'gamepad', 'gamepad-2', 'joystick',
    'key', 'key-off', 'key-check', 'key-x', 'key-plus', 'key-minus', 'lock-open', 'lock-keyhole',
