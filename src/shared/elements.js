...
window.OverlayElements = (function () {
  ...
  const ICONS = [
    ...
    'credit-card', 'wallet', 'dollar-sign', 'euro', 'pound-sterling', 'bitcoin', 'cash',
    ...
    'percent', 'divide', 'equals', 'not-equals', 'greater-than', 'less-than',
    ...
    'user-search', 'user-cog', 'user-star', 'user-lock', 'user-unlock',
    'crown', 'building', 'building-2', 'hotel', 'hospital', 'school',
    'university', 'factory', 'construction', 'hard-hat', 'wrench', 'screwdriver',
    ...
    'monitor-off', 'printer-off', 'gamepad-2', 'joystick', 'lock-open',
    'shield-off', 'shield-alert', 'shield-heart', 'shield-star'
  ];
